                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group label-floating">
                                                        ...
                                                        <input type="text" class="form-control" name="txtCategoryId" value="${category.categoryId}" readonly="">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group label-floating">
                                                        ...
                                                        <input type="text" class="form-control" name="txtCategoryName" value="${category.categoryName}" pattern="[A-Za-z0-9 /-]{1,100}" required title="Category name contains 1 to 100 characters">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group label-floating">
                                                        ...
                                                        <textarea rows="10" cols="80" class="form-control" name="txtDescription" maxlength="500">${category.categoryDesc}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group label-floating">
                                                        ...
                                                        <input type="text" class="form-control" name="txtIcon" value="${category.categoryIcon}" maxlength="200">
                                                    </div>
                                                </div>
                                            </div>
                                            <button type="submit" name="action" class="btn btn-primary" value="editCategory">Save</button>
